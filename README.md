...
```bash
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.13.10/install.sh | bash -s -- --rc
```
...
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.13.10/install.sh | C4J_REF=v0.13.10 bash -s -- --rc
...
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.13.10/install.sh | C4J_INSTALL_DIR="$HOME/src/c4j" bash -s -- --rc
