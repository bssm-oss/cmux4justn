...
```bash
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.13.0/install.sh | bash
```
...
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.13.0/install.sh | C4J_REF=v0.13.0 bash
...
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.13.0/install.sh | C4J_INSTALL_DIR="$HOME/src/c4j" bash
