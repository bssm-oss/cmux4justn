...
```bash
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.13.13/install.sh | bash -s -- --rc
```
...
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.13.13/install.sh | C4J_REF=v0.13.13 bash -s -- --rc
...
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.13.13/install.sh | C4J_INSTALL_DIR="$HOME/src/c4j" bash -s -- --rc
