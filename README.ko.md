...
```bash
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.13.12/install.sh | bash -s -- --rc
```
...
```bash
# 특정 릴리즈를 설치합니다.
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.13.12/install.sh | C4J_REF=v0.13.12 bash -s -- --rc
...
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.13.12/install.sh | C4J_INSTALL_DIR="$HOME/src/c4j" bash -s -- --rc
