...
```bash
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.13.4/install.sh | bash
```
...
```bash
# 특정 릴리즈를 설치합니다.
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.13.4/install.sh | C4J_REF=v0.13.4 bash
...
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.13.4/install.sh | C4J_INSTALL_DIR="$HOME/src/c4j" bash
