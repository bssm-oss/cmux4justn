...
```bash
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.14.2/install.sh | bash -s -- --rc
```
...
```bash
# 특정 릴리즈를 설치합니다.
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.14.2/install.sh | C4J_REF=v0.14.2 bash -s -- --rc
...
curl -fsSL https://raw.githubusercontent.com/bssm-oss/cmux4justn/v0.14.2/install.sh | C4J_INSTALL_DIR="$HOME/src/c4j" bash -s -- --rc
